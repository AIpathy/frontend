...
import PHQ9SonucGrafik from "./PHQ9SonucGrafik";
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] relative">
      ...
      <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-md mt-16">
        <h2 className="text-2xl font-bold text-[#265d5c] mb-4">PHQ-9 (Hasta Sağlığı Anketi) Testi</h2>
        ...
        {submitted && (
          <div className="mt-8 border-t pt-6">
            ...
            <PHQ9SonucGrafik score={totalScore} />
          </div>
        )}
      </div>
    </div>
