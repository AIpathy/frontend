...
import ICG5SonucGrafik from "./ICG5SonucGrafik";
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] relative">
      ...
      <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-md mt-16">
        <h2 className="text-2xl font-bold text-[#265d5c] mb-4">ICG-5 (Karmaşık Yas Ölçeği) Testi</h2>
        ...
        {submitted && (
          <div className="mt-8 border-t pt-6">
            ...
            <ICG5SonucGrafik score={totalScore} />
          </div>
        )}
      </div>
    </div>
